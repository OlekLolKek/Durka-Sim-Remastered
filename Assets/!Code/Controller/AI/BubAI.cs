...
{
    public class BubAI : IInitialize, IExecute, ICleanup
    {
        ...
        private readonly BubView _view;
        ...
        private const float DEFAULT_JUMP_FORCE = 250.0f;
        
        private const float CHARGE_TIME = 1.0f;
            ...
            Transform target, AIConfig aiConfig)
        {
            ...
            _view.OnBubCollision += OnBubCollision;
        }
        ...
        private void OnBubCollision(Collision2D collision)
        {
        ...
        private void RaycastToPlayer(float deltaTime)
        {
            ...
            var hit = Physics2D.Raycast(
                position, direction, 
                _aiConfig.VisibilityLength, _aiConfig.LayerMask);
